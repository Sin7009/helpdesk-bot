...
Команда: /add_faq "личный кабинет" "Для восстановления доступа..."
```
...
├── test_university_improvements.py  # Тесты университетских функций
├── test_llm_service.py          # Тесты LLM интеграции
├── test_security_sanitization.py    # Тесты безопасности
└── ...                          # 70+ тестов
```
...
- [ ] Команда `/assign` для назначения тикетов
